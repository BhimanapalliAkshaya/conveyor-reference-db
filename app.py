...
with gr.Blocks(title="ESP32 - Conveyor Monitoring System") as demo:
...
# --- CLOUD DEPLOYMENT PORT BINDING ---
port = int(os.environ.get("PORT", 7860))
demo.launch(inline=True, server_name="0.0.0.0", server_port=port, css=vibrant_css)
...
/* Primary Tab/Main Heading Style */
.heading-telemetry {
...
/* Highlighted Internal Sub-Headings */
.heading-internal {
...
with gr.Blocks(css=vibrant_css, title="ESP32 - Conveyor Monitoring System") as demo:
    ...
    # Header Banner with Rich Gradient and Neon Accents
    with gr.Row():
        gr.Markdown(
            """
    ...
    with gr.Tabs():
        with gr.TabItem("📊 Live Telemetry Dashboard"):
            ...
            # Internal Sub-Heading for the Vision Feed/Input Section
...
if __name__ == "__main__":
    # Dynamically fetch Render's assigned cloud port, fallback to 10000 locally
    port = int(os.environ.get("PORT", 10000))
    
    # Bind to 0.0.0.0 so all external mobile devices and network connections work smoothly
